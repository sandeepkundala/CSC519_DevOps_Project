...
const ITRUST_RELATIVE_PATH =
  "iTrust2-v6/iTrust2/src/main/java/edu/ncsu/csc/itrust2";
...
async function calculatePriority(numberOfIterations) {
  child.execSync(
    `cd /home/vagrant/iTrust2-v6/iTrust2 && sudo mvn -f pom-data.xml process-test-classes && mysql -u root -e 'DROP DATABASE IF EXISTS iTrust2'`
  );
  for (var i = 0; i < numberOfIterations; i++) {
    ...
    while (maxRetries > 0) {
      ...
      try {
        ...
        child.execSync(
          "cd /home/vagrant/iTrust2-v6/iTrust2 && sudo mvn clean test verify"
        );
      } catch (e) {
